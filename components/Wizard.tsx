...
export default function Wizard({ open, onClose, ocId, onCPIFSaved, selectedTab: propSelectedTab, isPageMode = false, isManageMode = false }: WizardProps) {
  ...
  const populateFormWithData = (row: CPIFDocument) => {
    ...
    setIndustry(row.accountInfo.industry);
    setEntityType(row.accountInfo.entityType);
    ...
    setProductService(row.accountInfo.productService);
    ...
    setLeadSource(row.accountInfo.leadSource);
    ...
    try {
      const cpifData: CPIFDocument = {
        ...
        accountInfo: {
          ...
          estOpptyValue: parseFloat(estOpptyValue) || 0,
        ...
        workdayProjectContract: {
          ...
          asstProjectManager: asstProjectManager,
          projectBillingSpecialist: projectBillingSpecialist,
          ...
          estimatedRealizationYear1: parseFloat(estimatedRealizationYear1) || 0,
          contractRateSheet: contractRateSheet,
          totalContractAmount: parseFloat(totalContractAmount) || 0,
          adminFeePercent: parseFloat(adminFeePercent) || 0,
          adminFeeIncludedExcluded: adminFeeIncludedExcluded,
          onboardingFeePercent: parseFloat(onboardingFeePercent) || 0,
